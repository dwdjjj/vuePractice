...
export default {
    ...
    methods: {
        ...
        registerTodo() {
            ...
            // if (this.todoTitle) this.$store.commit("CREATE_TODO", todoItem);
            // if (this.todoTitle) this.$store.dispatch("createTodo", todoItem);
            if (this.todoTitle) this.createTodo(todoItem);
        },
    },
};
</script>
